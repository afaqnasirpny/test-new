...
```
cd existing_repo
git remote add origin https://gitlab.com/Farooq7242/flask-example.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Farooq7242/flask-example/-/settings/integrations)
